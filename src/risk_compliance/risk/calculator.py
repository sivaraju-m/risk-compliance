...
class RiskCalculator:
    ...
    def calculate_portfolio_risk(self, positions: Dict[str, float], 
        ...
        try:
            ...
            risk_metrics['max_drawdown'] = self.calculate_maximum_drawdown(portfolio_returns)
    ...
    def _calculate_portfolio_returns(self, positions: Dict[str, float], 
        ...
        try:
            ...
            for symbol, weight in weights.items():
                if symbol in returns_data:
                    symbol_returns = returns_data[symbol].reindex(common_dates, fill_value=0)
    ...
    def calculate_stress_test(self, positions: Dict[str, float], 
