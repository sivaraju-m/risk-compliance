...
class ConfigLoader:
    ...
    def load_risk_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not config_file.exists():
                self.logger.info(f"Risk config file not found at {config_file}, creating default")
    ...
    def load_compliance_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not config_file.exists():
                self.logger.info(f"Compliance config file not found at {config_file}, creating default")
    ...
    def load_monitoring_config(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not config_file.exists():
                self.logger.info(f"Monitoring config file not found at {config_file}, creating default")
    ...
    def load_expanded_universe(self) -> Dict[str, Any]:
        ...
        try:
            ...
            universe_paths = [
                ...
                self.config_dir.parent.parent.parent / "ai-trading-machine" / "config" / "expanded_universe.json",
    ...
    def _get_default_universe(self) -> Dict[str, Any]:
        ...
        return {
            "large_cap": [
                ...
                "KO", "AVGO", "WMT", "LLY", "TMO", "DIS", "XOM", "CVX", "NKE"
            ],
            "mid_cap": [
                "AMD", "CRM", "ORCL", "ACN", "TXN", "QCOM", "MDT", "COST", "NEE",
                "DHR", "VZ", "ADBE", "ABT", "AMGN", "PM", "UNP", "T", "BMY"
            ],
            "small_cap": [
                "ETSY", "ROKU", "PINS", "SNAP", "SPOT", "SQ", "TWLO", "ZM",
                "DOCU", "OKTA", "CRWD", "NET", "FSLY", "DBX", "WORK"
            ],
            "sectors": {
                "technology": ["AAPL", "MSFT", "GOOGL", "META", "NVDA", "AMD", "CRM", "ORCL"],
                "healthcare": ["JNJ", "UNH", "PFE", "ABBV", "LLY", "TMO", "DHR", "MDT", "ABT", "AMGN", "BMY"],
