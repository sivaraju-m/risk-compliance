...
class ComplianceViolation:
    ...
    def __init__(self, rule_name: str, violation_type: str, details: Dict[str, Any],
...
class ComplianceChecker:
    ...
    def _setup_default_rules(self):
        ...
        default_rules = [
            ...
            ComplianceRule(
                "trading_hours",
                "trading_time",
                {"market_open": "09:30", "market_close": "16:00", "timezone": "US/Eastern"},
                "WARNING"
            )
        ]
    ...
    def check_trade_compliance(self, trade_order: Dict[str, Any], 
                             current_positions: Dict[str, float],
                             market_data: Optional[Dict[str, Any]] = None) -> List[ComplianceViolation]:
        ...
        try:
            ...
            for rule_name, rule in self.compliance_rules.items():
                ...
                violation = self._check_rule(rule, trade_order, current_positions, market_data)
                if violation:
    ...
    def _check_rule(self, rule: ComplianceRule, trade_order: Dict[str, Any],
                   current_positions: Dict[str, float], 
                   market_data: Optional[Dict[str, Any]]) -> Optional[ComplianceViolation]:
        ...
        try:
            if rule.rule_type == "position_size":
                ...
                return self._check_concentration(rule, trade_order, current_positions, market_data)
    ...
    def _check_position_size(self, rule: ComplianceRule, trade_order: Dict[str, Any],
                           current_positions: Dict[str, float]) -> Optional[ComplianceViolation]:
    ...
    def _check_concentration(self, rule: ComplianceRule, trade_order: Dict[str, Any],
                           current_positions: Dict[str, float], 
                           market_data: Optional[Dict[str, Any]]) -> Optional[ComplianceViolation]:
    ...
    def _check_turnover(self, rule: ComplianceRule, trade_order: Dict[str, Any],
                       current_positions: Dict[str, float]) -> Optional[ComplianceViolation]:
    ...
    def _check_wash_sale(self, rule: ComplianceRule, trade_order: Dict[str, Any],
                        current_positions: Dict[str, float]) -> Optional[ComplianceViolation]:
    ...
    def _check_short_selling(self, rule: ComplianceRule, trade_order: Dict[str, Any]) -> Optional[ComplianceViolation]:
    ...
    def _check_leverage(self, rule: ComplianceRule, trade_order: Dict[str, Any],
                       current_positions: Dict[str, float]) -> Optional[ComplianceViolation]:
    ...
    def _check_trading_hours(self, rule: ComplianceRule, trade_order: Dict[str, Any]) -> Optional[ComplianceViolation]:
        ...
        try:
            ...
            # Parse market hours
            market_open = time.fromisoformat(rule.parameters.get("market_open", "09:30"))
            market_close = time.fromisoformat(rule.parameters.get("market_close", "16:00"))
    ...
    def get_compliance_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "error_violations": len([v for v in self.violations if v.severity == "ERROR" and not v.resolved]),
            "warning_violations": len([v for v in self.violations if v.severity == "WARNING" and not v.resolved])
        }
    ...
    def resolve_violation(self, violation_index: int):
        ...
        if 0 <= violation_index < len(self.violations):
            ...
            self.logger.info(f"Resolved violation: {self.violations[violation_index].rule_name}")
    ...
    def export_rules_config(self) -> Dict[str, Any]:
        ...
        return {
            rule_name: {
                ...
                "last_violation": rule.last_violation.isoformat() if rule.last_violation else None
            }
            for rule_name, rule in self.compliance_rules.items()
        }
        ...
        try:
            for rule_name, rule_config in config.items():
                ...
                if "last_violation" in rule_config and rule_config["last_violation"]:
                    rule.last_violation = datetime.fromisoformat(rule_config["last_violation"])
